namespace Blueve.ObjectRedisMapping.UnitTests
{
    ...
    public class EntityKeyGeneratorTests
    {
        ...
        {
            var typeMetadata = this.typeRepo.GetOrRegister(typeof(PlainEntity));
        ...
        {
            var typeMetadata = this.typeRepo.GetOrRegister(typeof(KeyIsObject_UseInterface_Entity));
        ...
        {
            var typeMetadata = this.typeRepo.GetOrRegister(typeof(KeyIsObject_UseInterface_NotImplement_Entity));
